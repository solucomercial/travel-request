...
exports.sendMonthlyReportToApprovers = sendMonthlyReportToApprovers;
const pool_1 = require("../../infra/db/pool");
const service_1 = require("../notificacoes/service");
async function sendMonthlyReportToApprovers() {
    const [summary, approvers] = await Promise.all([
      ...
      `),
        (0, pool_1.query)(`SELECT email::text, nome FROM usuarios WHERE role = 'APROVADOR' AND ativo = TRUE`)
    ]);
